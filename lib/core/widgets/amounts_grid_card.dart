      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: selected == 1 ? AppColor.red : AppColor.transparent,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: selected == 2
                ...
                : Border.all(color: AppColor.grey, width: 2),
            borderRadius: BorderRadius.circular(2),
            color: selected == 2 ? AppColor.red : AppColor.transparent,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: selected == 3
                ...
                : Border.all(color: AppColor.grey, width: 2),
            borderRadius: BorderRadius.circular(2),
            color: selected == 3 ? AppColor.red : AppColor.transparent,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: selected == 4
                ...
                : Border.all(color: AppColor.grey, width: 2),
            borderRadius: BorderRadius.circular(2),
            color: selected == 4 ? AppColor.red : AppColor.transparent,
